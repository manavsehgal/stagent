...
export function TelemetryRail() {
  ...
  return (
    <div
      ...
      className="rail-instrument sticky top-[var(--chrome-header)] z-[var(--z-rail)] flex w-full min-w-0 max-w-full flex-none items-stretch overflow-hidden border-b border-border"
    >
